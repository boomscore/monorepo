...
export const HeadToHead: React.FC<HeadToHeadProps> = ({
  ...
  if (loading) {
    return (
      <div className="space-y-2">
        <h3 className="font-semibold text-base mb-4">Head to Head</h3>
  ...
  // Use pre-calculated comprehensive statistics from backend (calculated from all matches)
      ...
      <div className="grid grid-cols-2 gap-4 text-sm mb-6">
        <div className="space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium">{avgPointsPerGame}</span>
          </div>
          <div className="flex justify-between">
        ...
        <div className="space-y-2">
          <div className="flex justify-between">
            ...
            <span className="font-medium">{homeWinPercent}%</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-600">Draw %</span>
            <span className="font-medium">{drawPercent}%</span>
          </div>
          <div className="flex justify-between">
